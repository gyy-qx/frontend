<template>
    <div id="assignOrdinary">
      ...
      <table id="assignOrdinary_table">
        <tr><el-button type="primary" icon="el-icon-plus"  @click="dialogVisible1 = true">添加任务题目</el-button></tr>
        <tr>
          <td style="width: 100px">考核类别</td>
          <td style="width: 100px">任务序号</td>
          <td style="width: 200px">任务内容</td>
          <td style="width: 200px" v-if="target[0].ordinaryOneTargetScore!==null&&target[0].ordinaryOneTargetScore!==0">是否支撑课程目标一</td>
          <td style="width: 200px" v-if="target[0].ordinaryTwoTargetScore!==null&&target[0].ordinaryTwoTargetScore!==0">是否支撑课程目标二</td>
          <td style="width: 200px" v-if="target[0].ordinaryThreeTargetScore!==null&&target[0].ordinaryThreeTargetScore!==0">是否支撑课程目标三</td>
          <td style="width: 200px" v-if="target[0].ordinaryFourTargetScore!==null&&target[0].ordinaryFourTargetScore!==0">是否支撑课程目标四</td>
          <td style="width: 200px" v-if="target[0].ordinaryFiveTargetScore!==null&&target[0].ordinaryFiveTargetScore!==0">是否支撑课程目标五</td>

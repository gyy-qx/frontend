<template>
  <div id="GradeDegreeReport" style="margin-left: 25%">
    ...
    font-size: 30px;">华北水利水电大学课程目标达成度评价表</h4>
      <table id="tableEdit">
        ...
        <tr>
          <td rowspan="2">年级</td>
          <td v-text="this.courseGrade" rowspan="2"></td>
        ...
        <tr v-if="target[0].courseWeightOne!=null">
          ...
          <td
            v-text="target[0].ordinaryOneTargetScore+target[0].experimentOneTargetScore+target[0].endingOneTargetScore"></td>
          <td
            v-text="parseFloat(classResult.courseOneOrdinaryScore + classResult.courseOneExperimentScore + classResult.courseOneEndingScore).toFixed(2)"></td>
        ...
        <tr v-if="target[0].courseWeightTwo!=null">
          ...
          <td
            v-text="target[0].ordinaryTwoTargetScore+target[0].experimentTwoTargetScore+target[0].endingTwoTargetScore"></td>
          <td
            v-text="parseFloat(classResult.courseTwoOrdinaryScore + classResult.courseTwoExperimentScore + classResult.courseTwoEndingScore).toFixed(2)"></td>
        ...
        <tr v-if="target[0].courseWeightThree!=null">
          ...
          <td
            v-text="target[0].ordinaryThreeTargetScore+target[0].experimentThreeTargetScore+target[0].endingThreeTargetScore"></td>
          <td
            v-text="parseFloat(classResult.courseThreeOrdinaryScore + classResult.courseThreeExperimentScore + classResult.courseThreeEndingScore).toFixed(2)"></td>
        ...
        <tr v-if="target[0].courseWeightFour!=null">
          ...
          <td
            v-text="target[0].ordinaryFourTargetScore+target[0].experimentFourTargetScore+target[0].endingFourTargetScore"></td>
          <td
            v-text="parseFloat(classResult.courseFourOrdinaryScore + classResult.courseFourExperimentScore + classResult.courseFourEndingScore).toFixed(2)"></td>
        ...
        <tr v-if="target[0].courseWeightFive!=null">
          ...
          <td
            v-text="target[0].ordinaryFiveTargetScore+target[0].experimentFiveTargetScore+target[0].endingFiveTargetScore"></td>
          <td
            v-text="parseFloat(classResult.courseFiveOrdinaryScore + classResult.courseFiveExperimentScore + classResult.courseFiveEndingScore).toFixed(2)"></td>
    ...
    <br>
    <el-button type="primary" v-print="printObj" id="printButton" style="margin-left: 30%;margin-bottom: 50px">
      打印年级达成度分析报告
    </el-button>
  </div>
</template>

<template>
  <div id="firstPage">
    ...
    <el-button @click="GetCourse">测试</el-button>
    <el-button @click="GetCourse" type="primary" style="margin-left: 16px;" v-for="(course,index) in courseList" :key="index" >
      {{course}}
    </el-button>
    <el-drawer
      title="教学大纲"
  ...
  export default {
    ...
    data () {
      return {
        ...
        targetR1: this.target.ordinaryOneTargetScore + this.target.experimentOneTargetScore + this.target.endingOneTargetScore,
        targetR2: this.target.ordinaryTwoTargetScore + this.target.experimentTwoTargetScore + this.target.endingTwoTargetScore,
        targetR3: this.target.ordinaryThreeTargetScore + this.target.experimentThreeTargetScore + this.target.endingThreeTargetScore,
        targetR4: this.target.ordinaryFourTargetScore + this.target.experimentFourTargetScore + this.target.endingFourTargetScore,
        targetR5: this.target.ordinaryFiveTargetScore + this.target.experimentFiveTargetScore + this.target.endingFiveTargetScore,
        courseList: null,
        course: {
          courseName: '',
          courseEnglish: '',
    ...
    methods: {
      ...
      GetCourse (event) {
        // this.course.courseName = event.target.value
